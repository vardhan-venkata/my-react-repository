      ...
      experiences: [
        {
          ...
          detailedDescription: [
            "Developed and implemented user-friendly and responsive user interfaces that work across different platforms and devices",
            "Integrated application with backend systems and APIs to create seamless user experience",
            "Participated actively in code review sessions, promoting adherence to established coding standards within team.",
            "Utilized version control tools such as Git for effective collaboration among team members during development cycles.",
            "Addressed and resolved multiple issues throughout application by fixing various bugs and glitches that were affecting its functionality and performance",
            "I researched various packages in React to aid in implementation of features more effectively and efficiently.",
            "Supervised and managed 5 team members for development of portal in a marketplace.",
            "Collaborated with 30 team members.",
            ...
            "Mentored junior developers on best coding practices, increasing overall team efficiency and skill level.",
            "Participated in sprint planning sessions, estimating task complexity and prioritizing work items accordingly.",
            "Identified opportunities for refactoring legacy codebase, resulting in improved maintainability and scalability over time.",
          ],
          color: "#0879bf",
        },
      ],
